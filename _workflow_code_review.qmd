...
Code review is the process of having someone else read, run(?) and provide
feedback.
...
We will work through the length equation pull requests and perform code
reviews before merging the work.

\

Work in pairs to review one-another's code.
If anyone in the audience opened a pull request back to my repository and
would like to volunteer we can review your code together!
