...
Create a **feature branch** and edit the `README.md` file to improve it.
...
If you are working in a fork then push to see these changes reflected as a
branch on the online remote repository.

<!----------------------------------------------------------------------------------->

## Extension Exercise - README {.smaller}

I have made my additions to the README in my original repository.

\

Since you have made a fork you can get these updates directly on GitHub
by "synchronising" your fork.

\

After doing this check out the `main` branch locally and pull to get the
changes in your local working directory.
