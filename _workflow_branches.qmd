...
Together we will create a local branch and add the energy equation to
`pendulum_equations.py`, add, commit, and push those changes.

\

You should then return to main and create another local branch to add the length
equation to `pendulum_equations.py`. Make sure you add and commit your changes!
